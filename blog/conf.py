...
BLOG_AUTHOR = "Victor Hernandez"  # (translatable)
BLOG_TITLE = "Thoughts, ideas and reminders | Thoughts, ideas and reminders"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.sysdev.co/blog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.sysdev.co/blog/"
BLOG_EMAIL = "victorliferock@gmail.com"
BLOG_DESCRIPTION = "This site contains my ideas and thoughts about anything, specially Python, Javascript, Linux, Vim... A lot of things..."  # (translatable)
